...
TARGET_PREBUILT_RECOVERY_KERNEL := device/huawei/u8951/kernel
TARGET_RECOVERY_INITRC := device/huawei/u8951/init.rc
TARGET_RECOVERY_FSTAB := device/huawei/u8951/recovery.fstab
